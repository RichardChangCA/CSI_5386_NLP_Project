# Title: Image Captioning with Keras: towardsdatascience

# https://towardsdatascience.com/image-captioning-with-keras-teaching-computers-to-describe-pictures-c88a46a311b8

# https://machinelearningmastery.com/prepare-photo-caption-dataset-training-deep-learning-model/

# state-of-the-art system created by Microsoft: Caption Bot

# datasets: Flickr 8k, Flickr 30k, MS COCO

# # imporve the solution:
# 1. using larger datasets
# 2. attention module
# 3. fine tunning
# 4. beam search instead of greedy search
# 5. BLEU score
...
with open("/home/lingfeng/Downloads/flicker8k-dataset/Pickle/encoded_train_images.pkl", "wb") as encoded_pickle:
...
with open("/home/lingfeng/Downloads/flicker8k-dataset/Pickle/encoded_test_images.pkl", "wb") as encoded_pickle:
...
# Load Glove vectors
glove_dir = '/home/lingfeng/Downloads/glove.6B'
...
model.save_weights('./model_weights/model.h5') # replace the older one
...
predict_result = greedySearch(image)
with open("results.txt",'w') as f:
    f.write("Greedy: "+ str(predict_result))
print("Greedy:",predict_result)
